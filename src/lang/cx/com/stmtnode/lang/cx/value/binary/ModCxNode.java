...
import com.stmtnode.primitive.value.binary.ModNativeNode;

public class ModCxNode extends BinaryCxNode {

	public ModCxNode(Token token, ValueCxNode left, ValueCxNode right) {
		this(token, null, left, right);
	}

	public ModCxNode(Token token, TypeCxNode type, ValueCxNode left, ValueCxNode right) {
	...
	public <E extends CodeNode> E link(NodeContext context) throws LinkException {
		...
		return cast(new ModCxNode(token, left.type, left, right));
	}
	...
	public ValueNativeNode toNative() {
		return new ModNativeNode(left.toNative(), right.toNative());
	}
