...
public class GreaterEqualNode extends BinaryNode {
	...
	public GreaterEqualNode(Token token, ValueCxNode left, ValueCxNode right) {
	...
	public <E extends CodeNode> E link(LinkContext context) throws LinkException {
		return cast(new GreaterEqualNode(token, linkNode(context, left), linkNode(context, right)));
	}
