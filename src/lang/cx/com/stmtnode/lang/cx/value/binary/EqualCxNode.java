...
import com.stmtnode.primitive.value.binary.EqualNativeNode;

public class EqualCxNode extends BinaryCxNode {

	public EqualCxNode(Token token, ValueCxNode left, ValueCxNode right) {
		this(token, null, left, right);
	}

	public EqualCxNode(Token token, TypeCxNode type, ValueCxNode left, ValueCxNode right) {
	...
	public <E extends CodeNode> E link(NodeContext context) throws LinkException {
		...
		return cast(new EqualCxNode(token, BoolTypeCxNode.GET, left, right));
	}
	...
	public ValueNativeNode toNative() {
		return new EqualNativeNode(left.toNative(), right.toNative());
	}
