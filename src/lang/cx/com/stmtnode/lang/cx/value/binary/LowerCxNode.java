...
import com.stmtnode.primitive.value.binary.LowerNativeNode;

public class LowerCxNode extends BinaryCxNode {

	public LowerCxNode(Token token, ValueCxNode left, ValueCxNode right) {
		this(token, null, left, right);
	}

	public LowerCxNode(Token token, TypeCxNode type, ValueCxNode left, ValueCxNode right) {
	...
	public <E extends CodeNode> E link(NodeContext context) throws LinkException {
		...
		return cast(new LowerCxNode(token, BoolTypeCxNode.GET, left, right));
	}
	...
	public ValueNativeNode toNative() {
		return new LowerNativeNode(left.toNative(), right.toNative());
	}
