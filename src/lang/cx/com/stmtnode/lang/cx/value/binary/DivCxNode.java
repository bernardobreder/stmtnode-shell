...
import com.stmtnode.primitive.value.binary.DivNativeNode;

public class DivCxNode extends BinaryCxNode {

	public DivCxNode(Token token, ValueCxNode left, ValueCxNode right) {
		this(token, null, left, right);
	}

	public DivCxNode(Token token, TypeCxNode type, ValueCxNode left, ValueCxNode right) {
	...
	public <E extends CodeNode> E link(NodeContext context) throws LinkException {
		...
		return cast(new DivCxNode(token, left.type, left, right));
	}
	...
	public ValueNativeNode toNative() {
		return new DivNativeNode(left.toNative(), right.toNative());
	}
