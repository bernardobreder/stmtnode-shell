...
import com.stmtnode.primitive.value.binary.SubNativeNode;

public class SubCxNode extends BinaryCxNode {

	public SubCxNode(Token token, ValueCxNode left, ValueCxNode right) {
		this(token, null, left, right);
	}

	public SubCxNode(Token token, TypeCxNode type, ValueCxNode left, ValueCxNode right) {
	...
	public <E extends CodeNode> E link(NodeContext context) throws LinkException {
		...
		return cast(new SubCxNode(token, left.type, left, right));
	}
	...
	public ValueNativeNode toNative() {
		return new SubNativeNode(left.toNative(), right.toNative());
	}
