...
import com.stmtnode.primitive.value.unary.PreIncNativeNode;

public class PreIncCxNode extends UnaryCxNode {

	public PreIncCxNode(Token token, ValueCxNode left) {
		this(token, null, left);
	}

	public PreIncCxNode(Token token, TypeCxNode type, ValueCxNode left) {
	...
	public ValueNativeNode toNative() {
		return new PreIncNativeNode(left.toNative());
	}
