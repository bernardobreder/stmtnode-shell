...
import com.stmtnode.primitive.value.unary.PosIncNativeNode;

public class PosIncCxNode extends UnaryCxNode {

	public PosIncCxNode(Token token, ValueCxNode left) {
		this(token, null, left);
	}

	public PosIncCxNode(Token token, TypeCxNode type, ValueCxNode left) {
	...
	public ValueNativeNode toNative() {
		return new PosIncNativeNode(left.toNative());
	}
