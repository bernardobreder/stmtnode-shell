...
import com.stmtnode.primitive.value.binary.AndNativeNode;

public class AndCxNode extends BinaryCxNode {

	public AndCxNode(Token token, ValueCxNode left, ValueCxNode right) {
		this(token, null, left, right);
	}

	public AndCxNode(Token token, TypeCxNode type, ValueCxNode left, ValueCxNode right) {
	...
	public <E extends CodeNode> E link(NodeContext context) throws LinkException {
		...
		return cast(new AndCxNode(token, left.type, left, right));
	}
	...
	public ValueNativeNode toNative() {
		return new AndNativeNode(left.toNative(), right.toNative());
	}
