...
public class NotCxNode extends UnaryCxNode {

	public NotCxNode(Token token, ValueCxNode left) {
		this(token, null, left);
	}

	public NotCxNode(Token token, TypeCxNode type, ValueCxNode left) {
	...
	public ValueNativeNode toNative() {
		return new NotNativeNode(left.toNative());
	}
